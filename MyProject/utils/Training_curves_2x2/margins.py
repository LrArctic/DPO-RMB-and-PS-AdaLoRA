...
df1 = load_and_smooth('2_margins.csv', 'Baseline', weight=0.9)
df2 = load_and_smooth('20_margins_false.csv', 'DPO-RMB+PS-AdaLoRA', weight=0.9)
...
ax.set_ylabel('Train margins', fontsize=12, fontweight='bold')
...
# 5. 紧凑布局并保存
plt.tight_layout()
plt.savefig('./margins_comparison_false.pdf', bbox_inches='tight') # 导出矢量 PDF
plt.show()