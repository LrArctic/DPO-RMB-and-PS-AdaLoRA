...
df1 = load_and_smooth('2_loss.csv', 'Baseline', weight=0.9)
df2 = load_and_smooth('20_loss.csv', 'DPO-RMB+PS-AdaLoRA', weight=0.9)
...
# 5. 紧凑布局并保存
plt.tight_layout()
plt.savefig('./loss_comparison.pdf', bbox_inches='tight') # 导出矢量 PDF
plt.show()